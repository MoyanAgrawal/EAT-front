...
var ToastRef = class {
  ...
  _afterClosed = new import_rxjs.Subject();
  /** triggered when toast is activated */
  _activate = new import_rxjs.Subject();
  /** notifies the toast that it should close before the timeout */
  _manualClose = new import_rxjs.Subject();
  /** notifies the toast that it should reset the timeouts */
  _resetTimeout = new import_rxjs.Subject();
  /** notifies the toast that it should count a duplicate toast */
  _countDuplicate = new import_rxjs.Subject();
...
var ToastPackage = class {
  ...
  toastType;
  toastRef;
  _onTap = new import_rxjs.Subject();
